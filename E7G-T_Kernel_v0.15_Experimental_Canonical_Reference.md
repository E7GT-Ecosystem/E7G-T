...
subtitle: "Executable Extension, Reciprocal Constitution and Checkable Reasoning"
version: "0.15-experimental"
release_label: "v0.15-experimental-MSC1"
date: "2026-09-25"
revision: "MSC1"
...
status: "Experimental canonical reference; speculative mathematical profiles with bounded executable subsets"
base_version: "0.14-experimental-REC1-draft"
constitutional_base_version: "0.11-UC5"
...
optional_recursive_profile: "RGP/0.2"
optional_whole_portion_profile: "WPC/0.2-proposed"
legacy_whole_portion_profile: "WPC/0.1"
optional_wpc_evolution_profile: "WPC-Evolution/0.1-proposed"
optional_wpc_distributed_profile: "WPC-Distributed/0.1-proposed"
optional_reasoning_profile: "REC/0.1-proposed"
optional_multiscope_profile: "MSC/0.1-proposed"
multiscope_reference_model: "MSC-B1/0.1"
reasoning_reference_model: "REC-B1/0.1"
symbolic_reference_model: "IC/0.1"
example_model: "FG3/0.1"
language_convention: "British English"
normativity: "Part I defines the v0.15 experimental canonical source and conditional EEC-Q, SF, CFS, RGP, WPC, REC and MSC profile obligations. REC/0.1 applies only when explicitly selected and constrains a bounded information-flow computation; it does not establish source truth, domain-rule validity or improved AI performance. WPC-Evolution and WPC-Distributed remain separate optional capabilities. Part II preserves the UC5 reference text and its existing normative/informative distinctions. Appendices V and VI retain limited predecessor implementation and validation accounts unchanged. Experimental canonical means the authoritative source edition for new work; it does not rewrite predecessor editions, automatically migrate consumers, establish full profile conformance, production readiness or maturity-gate completion."
ai_use: "Treat E7G-T as a geometry-first modelling language with experimental constructive, reciprocal and checkable-reasoning profiles. Apply EEC-Q, SF, CFS, RGP, WPC, REC or MSC only when explicitly selected. Under REC/0.1 distinguish claim content, information status, source truth and action authority; retain support and refutation independently; reject hidden scope, temporal and modality expansion; require explicit rules and a replayable witness; and abstain when the selected reliance policy is not satisfied. Do not reinterpret EEC-Q coefficients as evidence weights. A passing REC trace proves only conformance of the declared bounded information flow; a compatible MSC family establishes model-relative coherence. Neither establishes factual truth, external existence, domain validity, intelligence improvement, physical ontology or production readiness."
---

# E7G-T Kernel v0.15 — Experimental Canonical Reference

**Executable Extension, Reciprocal Constitution and Checkable Reasoning**

**Authors:** Alexander Gregory Wingate and Oleksandr Razinkov
**Copyright:** © 2026 Alexander Gregory Wingate and Oleksandr Razinkov
**Licence:** [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)

> **v0.15 working definition.** E7G-T is a geometry-first modelling language and practical calculus for constructing, extending, combining, transforming and viewing bounded relational entities, and for examining their preservation, loss, histories and inquiry-relative phases. Its experimental profiles distinguish constitution from representation, test coherence among independently constituted scopes, and may evaluate finite claim–evidence systems through declared rules. MSC compatibility is relative to stated carriers and maps; a REC result retains support and refutation independently and carries a replayable witness. Neither establishes external existence or source truth.
...
| Part | Content | Role |
|---|---|---|
| I, §§X.0–X.21 | v0.15 experimental definitions, rules, examples, implementation contract and migration | Current experimental canonical source; profile maturity varies |
...
References written **UC5 §n** point into Part II. References written **§X.n** point into Part I. References written **§W.n** point into WPC/0.2 in §X.19; references written **§C.n** point into REC/0.1 in §X.20; references written **§MSC.n** point into §X.21. The source's historical front matter is recorded before Part II; only the front matter at the beginning of this document describes v0.15.

# Part I — Executable Extension, Recursive Structure, Reciprocal Constitution and Multi-Scope Coherence
...
| RGP/0.2 | Optional recursive generative-projective structures with typed hosting, generation, whole-bearing encoding, decoding, contextual expression, inheritance, coherent composition and transformation | Extended in §X.18; structural specification without a claim of external instantiation |
| WPC/0.1 | Legacy fixed-scope whole–portion coherence over RGP/0.2 | Retained unchanged in §R.5.4 for pinned compatibility |
| WPC/0.2 | Optional reciprocal whole–part constitution: coverage, constitution, representation, local expression and exact closure | Proposed in §X.19; bounded executable subset, not a complete implementation |
| WPC-Evolution/0.1 | Optional proposal, reconciliation, commitment, refresh and causal-history capability | Proposed in §W.7; not required for static WPC/0.2 conformance |
| WPC-Distributed/0.1 | Optional concurrency, partial-failure, currentness and availability capability | Proposed in §W.8; requires a selected deployment model |
| REC/0.1 and REC-B1/0.1 | Optional typed claim–evidence reasoning, four information statuses, scope and modality safety, deterministic witnesses and replay | Proposed in §X.20; bounded executable subset, not a truth or AI-performance claim |
| MSC/0.1 and MSC-B1/0.1 | Optional multi-scope compatible-family, obstruction, quotient and reconstruction-fibre semantics | Proposed in §X.21; bounded finite first-party implementation, not an external-existence claim |
...
**MUST**, **MUST NOT**, **SHOULD** and **MAY** have the obligation meanings used in UC5. An EEC-Q requirement applies only to an implementation or derivation declaring that profile. SF, CFS, RGP, WPC, REC and MSC obligations apply only when their respective profiles are selected. WPC/0.1 and WPC/0.2 remain distinct pinned profiles; WPC evolution and distributed obligations require their additional capabilities. REC/0.1 constrains only its declared finite claim–evidence computation. Each supported model and capability scope must be declared. Ordinary E7G-T analyses do not acquire a requirement to use rational coefficients, finite graphs, cancellation, recursive frames, whole–part constitution or REC.

Part I governs the v0.15 experimental canonical source and its selected profiles. Part II governs inherited concepts except for the explicit refinements listed in §X.14. Nothing here promotes UC5's informative observation, temporal-orientation, topology or relative-support pilots to the normative constitutional core.
...
**Canonical source and completion are separate.** This edition supersedes v0.12.1 as the default source for *new* citations; v0.12.1/RGP2, v0.13/RWP1 and v0.14/REC1 remain immutable edition-pinned references. E7C/0.1 remains an incomplete research calculus. In particular, its all-input Python/IR-to-Lean implementation link for the selected EEC-Q Joint operation is unproved. The required EEC-Q, SF, CFS, RGP, WPC, MSC and REC completion rows remain open, and WPC-Distributed is unsupported. Published experimental definitions do not constitute implementations, proofs of all-input fidelity, empirical validation or automatic adoption by a product.
...
| Term | Meaning in the experimental source | What does not follow automatically |
|---|---|---|
...
| UC5 element | v0.15 successor treatment | Compatibility consequence |
|---|---|---|
...
| RGP/0.2 and WPC/0.1 | Retained as pinned recursive and fixed-scope whole-bearing profiles | Existing WC0–WC4 results keep their original semantics |
| WPC/0.2 | Adds constitutive presentation, semantic whole, materialised assembly, extraction, constitution and normalised reciprocal closure | Constitution no longer presupposes all-portions encoding; claims use a capability vector |
| WPC-Evolution and WPC-Distributed | Added as optional modules | Static WPC/0.2 implementations need not claim reconciliation, commitment or distributed consistency |
| REC/0.1 | Adds typed claim–evidence information flow, four non-collapsing statuses, rule witnesses, scope and modality safety, decision policies and replay | A conforming trace is not a source-truth, domain-validity or improved-intelligence claim |
| MSC/0.1 | Adds typed finite scope diagrams, compatible-family closure, obstruction, access quotients and reconstruction fibres | Link-wise satisfiability need not imply global compatibility; no external existence or higher-scope authority follows |
...
The working definition at the beginning of v0.15 makes construction, computation, reciprocal whole–part constitution and optionally checkable reasoning explicit. It retains the UC5 distinction between source, representation, phase and evidence. It does not turn every E7G-T use into an algebraic execution, every constituent into an SR4 encoder, every composition into a uniquely admitted whole or every explanation into a verified REC derivation.
...
2. Keep the recorded v0.12 companion implementations pinned to `kernel=0.12-experimental`; their embedded identifiers and validation hashes are not rewritten by this patch release.
3. For a new v0.15 artefact, declare `kernel=0.15-experimental`, every selected profile and the supported model edition. Earlier editions retain their own labels and require an explicit migration check.
4. Supply exact configuration identity, coefficient semantics and joint-dependence declarations.
5. Type every projection as view, identification or restriction at the execution boundary; under RGP, type encoding and decoding separately.
6. Recheck phase operations for domain saturation and result congruence.
7. State omitted UC5 features and unimplemented profile features. Do not claim full compatibility on the basis of a shared version label.
8. Keep WPC/0.1 results pinned to their legacy meaning. When selecting WPC/0.2, declare the constitutive presentation, semantic whole, materialised assembly, coverage contract and independent capability vector. Select WPC-Evolution or WPC-Distributed only when their additional obligations are implemented.
9. Do not translate WC0–WC4 mechanically into the WPC/0.2 vector. Re-run the applicable coverage, constitution, extraction, payload-agreement, normalisation and closure checks on the new declared domains.
10. When selecting REC/0.1, pin the claim, evidence, rule and query envelope; retain support and refutation independently; state scope, time, modality and dependence groups; and publish a replayable witness. Do not infer source truth or domain authority from trace validity.
11. When selecting MSC/0.1, pin finite scope carriers, common-codomain maps, comparison criteria, partial domains, editions and resource policy. Keep `incompatible`, `unsupported`, `undetermined` and `resource_limit` distinct; do not infer a global family from link-wise satisfiability.
12. Existing E7C source registry entries, proofs, IR editions and differential fixtures retain their v0.12.1/v0.13/v0.14 pins until a separate v0.15 edition-specific refinement is reviewed. No product data, API or schema is migrated by this source designation.

E7Q remains an independently versioned quantum evidence and verification direction. EEC-Q is a constructive language foundation within E7G-T; it can be developed without requiring E7Q to become that language. Future adapters can connect them through explicit contracts. The ecosystem operating kernel remains a separate document and is not revised by this source edition.
...
- Which bounded applications require recursive generation, access-limited projection or distributed source retention beyond ordinary quotation and composition?
- Which relation types and witnesses are sufficient to implement RGP without conflating hosting, generation, encoding, decoding, projection, inheritance and composition?
- Which concrete systems benefit from distinguishing a reconstructive whole from a compositional whole, and what bridge between them is operationally useful?
- Which overlap criteria permit differentiated local expressions to remain globally coherent without requiring them to be identical?
- Which update protocols preserve reciprocal closure under partial failure, asynchronous migration or changing portion membership?
- Which domain adapters can map source material to REC claims without hiding semantic-extraction error?
- Which rule language and checker boundary provide useful reasoning power while retaining deterministic replay and honest failure?
- Does REC enforcement measurably improve accuracy, unsupported-claim rate, scope safety, conflict retention and abstention compared with simpler prompting and retrieval baselines?
- Which MSC comparisons admit a useful global compatible-family witness, and which require an obstruction or explicit abstention?
- What problem benefits enough from this language to justify its implementation and review cost?

Full language and calculus completion still require a published grammar and interchange schema, implementations covering each claimed capability, independent reproduction of positive and negative cases, at least one useful end-to-end program, and a reviewed compatibility account. Canonical source status does not close those gates. Performance or quantum claims require separate evidence appropriate to those claims.

The v0.15 source retains the v0.13 constructive and reciprocal profiles, v0.14 REC/0.1, and adds MSC/0.1 as a separately selectable multi-scope formal proposal. The bounded REC-B1 model checks declared finite information flow; it does not supply a natural-language semantic parser, general theorem prover, source-truth oracle, domain authority engine or empirical proof of improved AI reasoning. A full language, OS, hardware mechanism, general WPC runtime and general-purpose verifier remain future engineering or research work. This experimental source is an implementable research target rather than a claim that the destination has already been reached.
...
## X.18 Optional recursive generative–projective structures — RGP/0.2

Added in revision **RGP1**, 2026-09-13, extended with exact whole-bearing encoding in revision **RGP2** on the same date, and extended to **RGP/0.2** by revision **WPC1**, 2026-09-14. RGP/0.2 is an optional structural profile for modelling finite hierarchies in which a bounded construction may host other constructions, generate locally differentiated successors, carry source-retaining encodings, expose restricted projections or contextual expressions, transmit declared invariants and participate in a coherent composite that can itself recur at a higher rank.

WPC1 formalises two compatible but non-identical claims: a reconstructive whole may be recoverable from every admitted whole-bearing portion, while a compositional whole consists of the differentiated portions together under declared interfaces. It does not identify these two wholes silently. Their relationship requires a typed bridge, a comparison criterion and explicit coherence witnesses.

RGP does not designate any particular application domain. Its objects may represent software environments, organisations, simulations, document systems, agent systems, biological organisations, design families or other typed structures. Selecting RGP asserts only the declared model and operations. It does not establish that a chosen external system instantiates them.

### R.0 Scope and anti-conflation rule

Capitalised MUST, MUST NOT, SHOULD and MAY express obligations on implementations or derivations claiming RGP compatibility. A conforming use MUST distinguish the following relations even when an informal description uses one word for several of them:

| Relation | Meaning |
|---|---|
| Hosting | One bounded construction occurs as an addressable component of another |
| Generation | A rule-bearing source constructs a successor under declared parameters |
| Encoding | A source is transformed into a portion intended to retain declared source content |
| Decoding | An admitted encoded portion is transformed back into a declared source sort |
| Projection | A source is mapped to a restricted target description or view |
| Contextual expression | A whole-bearing portion produces a local manifestation under declared role, time, regime, access and inquiry coordinates |
| Inheritance | Declared source invariants, rules or interfaces are retained by a successor |
| Composition | Several components form a new bounded relational construction |

None of these relations implies another. A hosted object need not have been generated by its host. A generated object need not be hosted by its generator. An encoding need not be a projection, view or contextual expression. A projection need not be a component of its source. An expression need not retain enough information to decode the whole. Decoding a reference through external retrieval is not self-contained reconstruction. Inheritance does not imply exact identity. Composition does not imply loss of component identity or reconstruction of a source whole.

RGP uses **layer** for one rule- and interface-bearing bounded construction. A layer is not a spatial dimension, D-role, TD-role, operational phase, execution rank or level of importance.

### R.1 Layer record and independent coordinates

An RGP layer is a record:

\[
L=\langle\Sigma,B,G,I,A,E,D,\Pi,X,K,M\rangle,
\]

where:

- \(\Sigma\) is the layer signature;
- \(B\) is its admitted configuration carrier;
- \(G\) is a finite typed family of generation or transformation rules;
- \(I\) is its external interface contract;
- \(A\) is an access policy assigning available operations or views to declared roles;
- \(E\) is a finite family of registered source-encoding operations;
- \(D\) is a finite family of corresponding decoding operations;
- \(\Pi\) is a finite family of typed projections or source-preserving views;
- \(X\) is a finite family of typed contextual-expression operations;
- \(K\) is a finite invariant contract;
- \(M\) is provenance and immutable edition metadata.

An implementation MAY support only a subset of these fields, but MUST declare omissions. Missing access, invariant or generation information is `unknown` or `unsupported` as appropriate; it is not an empty policy or unrestricted permission.

Each layer occurrence has separately declared coordinates:

\[
\operatorname{place}(L)=
\langle r,\rho,\tau,\alpha,c\rangle,
\]

where \(r\) is construction rank, \(\rho\) is an optional operational regime, \(\tau\) is temporal scope, \(\alpha\) is access scope and \(c\) is composition scope. Equality or order on one coordinate supplies no equality or order on the others.

### R.2 Typed structural relations

RGP provides the following relation signatures:

\[
\begin{aligned}
\mathsf{Hosts}(H,q_X,j)&,\\
\mathsf{Generates}_g(P,\theta)&=C,\\
\mathsf{Encodes}_{e_i}(W)&=F_i,\\
\mathsf{Decodes}_{d_i}(F_i)&=W',\\
\mathsf{Projects}_\pi(S)&=V,\\
\mathsf{Expresses}_{\chi_i}(F_i,\xi)&=X_{i,\xi},\\
\mathsf{Inherits}_\kappa(C,P)&,\\
\mathsf{Compose}_J(X_1,\ldots,X_n)&=Y.
\end{aligned}
\]

`Hosts` requires a quoted construction or another explicitly admitted component, an interface position \(j\), and a host boundary contract. Hosting does not execute the quoted interior.

`Generates` applies a declared typed rule \(g\) to a parent layer \(P\) and admitted parameter assignment \(\theta\). The result is a new immutable child layer \(C\). The rule MUST state which parent fields are copied, transformed, hidden, replaced or left unresolved.

`Encodes` applies a declared encoder \(e_i\) to a source \(W\) and returns a portion \(F_i\) whose retained content, identity, scope and decoder binding are explicit. An encoder declaration MUST state its source and portion sorts, domain, portion-index scope, canonicalisation, capacity assumptions and claimed source-retention tier.

`Decodes` applies the decoder bound to the encoder edition and returns a source-sort value or an explicit failure. Successful decoding alone does not establish exact recovery; the comparison criterion and retention tier determine that claim.

`Projects` is typed as either a source-preserving view or an identifying map under §X.6. A projection declaration MUST state its source, target signature, access role, preserved structure, lost structure and reconstruction fibre or unavailability statement.

`Expresses` applies a declared local-expression operation \(\chi_i\) to a portion and context record \(\xi\). The context MUST pin every coordinate on which the manifestation depends, including any applicable role, time, regime, access scope and inquiry. The operation MUST declare whether it is read-only, state-changing or generative, and MUST retain provenance to the portion and source edition. Contextual derivation does not make the expression identical to the portion or the whole.

`Inherits` is witnessed by an invariant map or validation predicate \(\kappa\). It does not mean that every parent rule or attribute occurs in the child.

`Compose` uses a declared interface family \(J\). It retains component identities unless \(J\) explicitly identifies them. The result may be packed and used at the next finite construction rank.

### R.3 Recursive generation and local differentiation

A generative chain is a finite sequence:

\[
L_0\xrightarrow{g_0,\theta_0}L_1
\xrightarrow{g_1,\theta_1}\cdots
\xrightarrow{g_{n-1},\theta_{n-1}}L_n.
\]

Each step records:

- the immutable parent edition;
- the generation rule and its edition;
- the parameter assignment or joint choice source;
- inherited invariants and discharged checks;
- introduced variations;
- unavailable or unresolved properties;
- the child boundary and interface contract.

A generated child MAY itself expose a generation interface. Recursive capability therefore means that the same typed pattern can be applied again at a greater finite rank; it does not create an actually completed infinite object.

When several child fields or descendants depend on one unresolved parameter, they MUST retain that shared choice. Independent expansion MUST NOT be inferred from separate appearances of the resulting components. EEC joint states, SF shared parameters or CFS pointwise dependence MAY implement this requirement.

### R.4 Local projection and reconstruction

For a layer \(L\), role \(a\) and temporal locality \(t\), a local access operation is:

\[
V_{a,t}=\mathsf{View}_{\pi_{a,t}}(L).
\]

The source-retaining model records \(L\), \(a\), \(t\), the projection edition and the loss account even when the role represented by \(a\) cannot access that source record. Model access and modelled-role access are separate.

For an identifying projection \(\pi:B_L\to B_V\), the reconstruction fibre is:

\[
\mathcal R_\pi(v)=\{x\in B_L:\pi(x)=v\}.
\]

A local target does not determine a unique source unless this fibre is proved singleton under the pinned signature and admission rules. A projection chain:

\[
L_n\xrightarrow{\pi_{n-1}}L_{n-1}
\xrightarrow{\pi_{n-2}}\cdots
\xrightarrow{\pi_0}V
\]

MUST record loss and identification at every step. End-to-end compatibility does not recover distinctions removed by an intermediate non-injective map.

### R.5 Distributed source retention

RGP separates five strengths of source retention. A use MUST name the strongest tier it establishes and MUST NOT infer a stronger tier from a weaker one.

| Tier | Name | Requirement |
|---|---|---|
| SR0 | Lineage anchor | The descendant retains an immutable reference to an admitted source edition |
| SR1 | Invariant retention | A declared source invariant is preserved in the descendant |
| SR2 | Generative retention | The descendant carries a typed rule fragment able to generate a declared class of further constructions |
| SR3 | Relative reconstructive sufficiency | A declared decoder reconstructs the source up to a pinned equivalence, with a proof or exhaustive bounded validation |
| SR4 | Exact whole reconstruction | The portion itself contains sufficient admitted content for a bound decoder to reproduce the exact canonical source |

Formally, SR1 for invariant \(k\) requires:

\[
k_P(P)=k_C(C)
\]

under an explicit comparison bridge. SR2 additionally requires an executable or formally specified generator with a stated domain and output class. SR3 requires a decoder \(d\) and criterion \(Q\) such that:
...
SR4 requires an encoder–decoder family indexed by admitted portion positions \(i\in I_W\):

\[
e_i:B_W\to B_{F_i},
\qquad
d_i:B_{F_i}\rightharpoonup B_W,
\]

with the exact left-inverse law:

\[
\forall W\in D_i:\qquad d_i(e_i(W))=W.
\]

Equality in this law is exact canonical source identity, including the source edition and all semantic fields declared inside the SR4 scope. Reconstruction only up to isomorphism, phase, view equality or another criterion remains SR3. The left-inverse law implies that \(e_i\) is injective on \(D_i\). An SR4 declaration MUST state the admitted source domain \(D_i\), portion-index set, encoder and decoder editions, exact identity procedure, retained payload and resource limits.

An encoding claim may cover one selected portion, a declared subset of portions or every portion admitted by a partition rule. The phrase `all-portions SR4` is conforming only when the left-inverse law is established for every admitted \(i\). A finite test establishes the law only for its recorded bounded domain.

#### R.5.1 Encoding, portion and local view

Whole-bearing encoding and local projection form separate stages:

\[
W\xrightarrow{e_i}F_i
\xrightarrow{\pi_{i,a,t}}V_{i,a,t}.
\]

Here \(F_i\) is the encoded portion and \(V_{i,a,t}\) is a role- and time-indexed view of it. The view may hide or identify information while the underlying portion still satisfies SR4. Consequently:

\[
d_i(F_i)=W
\]

does not imply that \(W\) can be reconstructed from \(V_{i,a,t}\). A view does not destroy the encoded payload unless an explicit state-changing operation replaces or modifies \(F_i\).

`Encode` is therefore not an alias for `Project`, `View`, `Pack` or `Restrict`. `Decode` is not an implicit source return. The encoder, decoder and exact identity check are executed explicitly.

#### R.5.2 Self-containment and permitted mechanisms

SR4 is self-contained relative to its declared decoding environment. The portion may contain:

1. a complete redundant canonical payload;
2. a reversible compressed payload with its codec edition;
3. a generative description and complete parameters sufficient to reproduce the exact source.

The decoding environment, including any fixed codec or interpreter, MUST be versioned and included in the claim boundary. A digest, source identifier, network location or retrieval capability without the source content establishes at most SR0. A generative rule that produces only a member of the same class establishes at most SR2. An external lookup that supplies missing source content MUST NOT be reported as self-contained SR4.

An implementation MUST state the information-capacity assumption that makes injective encoding possible on its admitted domain. When the portion carrier cannot distinguish every admitted source, SR4 is impossible for that carrier. Compression changes representation size; it does not waive injectivity or the left-inverse law.

#### R.5.3 Decoding outcomes and damage

Decoding returns one of:

| Outcome | Meaning |
|---|---|
| `exact(source)` | The decoded value is canonically identical to the declared source |
| `relative(source,Q)` | Reconstruction succeeds only under criterion \(Q\); this is SR3, not SR4 |
| `invalid_encoding` | Portion syntax, identity, codec binding or admission fails |
| `domain_error` | The portion is outside the decoder's declared domain |
| `insufficient` | The available portion cannot distinguish a unique exact source |
| `unsupported` | The required decoder or identity procedure is unavailable |
| `resource_limit` | Exact decoding or comparison stopped before completion |

Damage, truncation or mutation creates a new portion value. Unless the declared code includes and validates an error-recovery rule that still returns the exact source, the new value does not retain the previous SR4 result. Silent best-effort recovery is non-conforming.

Shared lineage, visual self-similarity, equal outputs or a common label establish none of SR1–SR4 by themselves. SR3 may hold for one inquiry while failing for another because its equivalence criterion is pinned to use. SR4 is not inquiry-relative within its declared exact payload scope.

#### R.5.4 Whole–portion coherence — WPC/0.1

WPC/0.1 formalises a bounded system in which every admitted portion may bear one reconstructive whole, the whole may express itself differently through each portion, and the differentiated portions together form one compositional whole. These are related claims, not synonyms.

A whole–portion system is a typed record:

\[
\mathcal W=
\langle
W,I_W,\{e_i,F_i,d_i,\chi_i\}_{i\in I_W},
J,Y,\alpha_J,\beta_J,\mathcal O,\mathcal T,M_W
\rangle.
\]

Here:

- \(W\in B_W\) is the **reconstructive whole**, pinned to one canonical source edition and payload scope;
- \(I_W\) is the admitted finite set of portion positions or occurrences;
- \(F_i=e_i(W)\) is the whole-bearing portion at position \(i\);
- \(d_i\) is its bound decoder;
- \(\chi_i\) is its contextual-expression family;
- \(J\) is the interface and component-retention contract;
- \(Y=\mathsf{Compose}_J((i,F_i)_{i\in I_W})\) is the **compositional whole**;
- \(\alpha_J:B_W\rightharpoonup B_Y\) is the canonical synthesis map which encodes and composes a reconstructive whole;
- \(\beta_J:B_Y\rightharpoonup B_W\) is the declared bridge from compositional-whole sort to reconstructive-whole sort;
- \(\mathcal O\) is the family of declared overlap and compatibility contracts among local expressions;
- \(\mathcal T\) is the family of admitted whole and portion transformations;
- \(M_W\) records editions, provenance, witnesses, domains and resource limits.

The indexed occurrence \((i,F_i)\), rather than the payload value \(F_i\) alone, participates in composition. Two equal payloads at different positions may therefore remain distinct components. Literal identity \(Y=W\) is not well typed unless both inhabit the same pinned carrier. In the general case their relationship is established only by \(\alpha_J,\beta_J\) and their declared identity or comparison rules.

##### R.5.4.1 Individual whole-bearing

The system has **all-portions exact whole-bearing** precisely when:

\[
\forall i\in I_W:\qquad
F_i=e_i(W)
\quad\land\quad
d_i(F_i)=W.
\]

This is the all-portions SR4 condition applied to one common exact source edition. It means that every admitted portion contains sufficient information, relative to its versioned decoding environment, to reconstruct \(W\). It does not mean that \(F_i\) and \(W\) are the same typed object or that every local view exposes the payload.

##### R.5.4.2 Cross-portion source coherence

Independent SR4 round trips do not alone prove that several supplied portions bear the same whole. A whole–portion coherence witness MUST establish:

\[
\forall i,j\in I_W:\qquad
d_i(F_i)=d_j(F_j)=W.
\]

The comparison includes the canonical source edition and every semantic field inside the declared payload scope. If two portions decode exactly but to different editions, each may retain SR4 individually while the collection fails WPC source coherence. A migration bridge may relate the editions, but it does not turn them into one exact source.

##### R.5.4.3 Contextual expression and local differentiation

For an admitted context record

\[
\xi=\langle a,t,\rho,\alpha,c,I\rangle
\]

containing the applicable role, temporal scope, regime, access scope, composition scope and inquiry, define:

\[
X_{i,\xi}=\mathsf{Expresses}_{\chi_i}(F_i,\xi).
\]

This commuting provenance triangle is required:

\[
X_{i,\xi}=\chi_i(e_i(W),\xi).
\]

It establishes that the local manifestation is an expression of the encoded whole through portion \(i\) under context \(\xi\). It does not establish \(X_{i,\xi}=F_i\), \(X_{i,\xi}=W\), or reconstructability of \(W\) from \(X_{i,\xi}\).

Every expression record MUST declare:

- the portion occurrence and source edition;
- the complete admitted context coordinates;
- the local structure introduced, selected, hidden or identified;
- whether the operation is read-only, state-changing or generative;
- the preserved source invariants and loss account;
- the local authority and transition boundary.

Local differentiation means that the expression is indexed by a real portion occurrence and context with a declared derivation path. It does not require different expressions to be unequal. Equal local outputs under one inquiry do not merge their portions or prove equal expression mechanisms.

For a declared overlap \(O_{ij}\), compatible contexts and restriction maps \(r_i^{ij},r_j^{ij}\) into a common comparison carrier, expression coherence requires:
...
The overlap criterion \(Q_{ij}\), bridges and domain MUST be declared. Portions may differ outside the overlap. When no common overlap or bridge is supplied, cross-expression agreement is `unsupported`, not automatically true.

##### R.5.4.4 Collective formation and reconstruction

The canonical synthesis map is:

\[
\alpha_J(W)
=\mathsf{Compose}_J((i,e_i(W))_{i\in I_W})
=Y.
\]

The contract \(J\) MUST retain or explicitly transform the index set, component occurrences, interfaces, provenance, access boundaries and shared-choice sources. Exact collective coherence requires a two-sided bridge on the declared coherent domains:
...
The first law establishes collective reconstruction. The second is the **collective closure law**: reconstructing the source whole and synthesising its complete indexed composition returns the same canonical compositional whole. Together they establish a typed isomorphism between the declared reconstructive-whole domain and coherent compositional-whole image without asserting literal cross-sort identity.

These conditions say that the differentiated portions together are a canonical expression of the reconstructive whole and that the two representations determine one another on the declared domain. They do not follow from all-portions SR4 and MUST be witnessed separately. The bridge declarations MUST state which components and relations they inspect, whether they check agreement among redundant payloads, and how they handle missing, stale, conflicting or damaged portions. If only \(\beta_J(Y)=W\) is established, the system is `collectively_reconstructive` but does not satisfy WC3 exact collective coherence because \(Y\) may contain organisation or state absent from \(W\).

For every \(i\in I_W\), let \(Y_{-i}\) be the admitted subcomposition with occurrence \(i\) removed. **Compositional participation** of every portion requires:
...
under a pinned compositional criterion \(Q_C\) that observes the retained occurrence or its declared contribution. This establishes that all indexed pieces participate in the identity or capability of the compositional whole. It does not require every piece to be informationally necessary for recovering \(W\).

There is an important non-conflation result. If all-portions SR4 holds and \(I_W\ne\varnothing\), then every single \(F_i\) is sufficient to reconstruct \(W\). Therefore the same system and payload scope cannot also claim that all portions are minimally necessary for reconstructing \(W\). What may require all portions is the exact identity, organisation, relation structure or emergent capability of \(Y\), not the information-theoretic recoverability of \(W\). A stronger `jointly necessary reconstruction` claim must use a different source scope or a weaker-than-SR4 portion code and MUST be versioned separately.

##### R.5.4.5 Transformation coherence

Let \(T:B_W\rightharpoonup B_{W'}\) be an admitted whole transformation, and let \(U_i:B_{F_i}\rightharpoonup B_{F_i'}\) be its declared local counterpart. With successor encoders and decoders \(e_i',d_i'\), exact transformation coherence requires both commuting laws:
...
\[
d_i'(U_i(F_i))=T(d_i(F_i)).
\]

The first law says that transforming the old portion agrees with encoding the transformed whole. The second says that local transformation and whole reconstruction agree. They are required on the common declared domain; neither is inferred from matching display output.

For the transformed composition

\[
Y'=\mathsf{Compose}_{J'}((i,U_i(F_i))_{i\in I_W}),
\]

collective transformation coherence additionally requires:

\[
\beta_{J'}(Y')=T(\beta_J(Y)).
\]

It also requires synthesis to commute:

\[
Y'=\alpha_{J'}(T(W))
=\mathsf{Compose}_{J'}((i,U_i(e_i(W)))_{i\in I_W}).
\]

If updates are not atomic, each portion and composite MUST carry an edition or epoch. A mixed-edition collection is `coherence_pending`, `coherence_conflict` or another declared non-success result until the required bridges and checks complete. It MUST NOT reuse the previous coherence witness merely because every portion remains individually decodable.

##### R.5.4.6 Coherence levels and outcomes

WPC claims are cumulative and MUST name the strongest demonstrated level:

| Level | Name | Requirement |
|---|---|---|
| WC0 | Typed whole–portion system | The complete record, sorts, indices, domains and contracts are declared |
| WC1 | Individual whole-bearing | Every admitted portion satisfies SR4 for the pinned \(W\) |
| WC2 | Source and expression coherence | WC1 plus common-source decoding and all declared overlap checks |
| WC3 | Collective coherence | WC2 plus component-complete composition, participation and the two-sided \(\alpha_J,\beta_J\) bridge laws |
| WC4 | Evolution coherence | WC3 plus the individual and collective commuting transformation laws on the declared domain |

Validation returns `coherent(level,witnesses)` only when every obligation through that level succeeds. Other outcomes include `collectively_reconstructive`, `invalid_system`, `domain_error`, `source_conflict`, `expression_conflict`, `composition_incomplete`, `collective_mismatch`, `closure_failure`, `coherence_pending`, `coherence_conflict`, `unsupported` and `resource_limit`. None is equivalent to an empty family, algebraic zero or successful lower-level claim unless that lower-level result is returned separately.

### R.6 Regimes, rank and transition

An operational regime is an optional typed record:

\[
D=\langle\Sigma_D,Q_D,T_D,A_D\rangle,
\]

where \(\Sigma_D\) is its admitted signature, \(Q_D\) its phase criteria, \(T_D\) its transitions and \(A_D\) its access contract. A regime identifier is not a rank.

A cross-regime transition is a partial typed operation:

\[
h_{D_i\to D_j}:B_{D_i}\rightharpoonup B_{D_j}.
\]

Its admission conditions, preserved invariants, losses and failure outcomes MUST be declared. Ordering regime labels does not prove reachability, progress, containment or greater construction rank.

One layer may support several regimes, and one regime may occur across several construction ranks. Phase equivalence within or across regimes still requires the conditions of §X.8.

### R.7 Temporal scope, whole histories and local selection

Let \(H\) be an admitted history or SF/CFS family of histories. A temporal locality is an explicit view:

\[
V_t=\mathsf{View}_{\pi_t}(H).
\]

Availability of \(H\) to the model does not imply availability to an entity represented inside \(V_t\). Representation of a complete history does not, by itself, establish that a local transition was caused, controlled or known from another temporal locality.

For an unresolved continuation family \(F_t\), a local selection operation MUST distinguish:

1. restricting the family by new conditions;
2. evaluating a supplied assignment;
3. realising under declared objectives;
4. recording an observed transition;
5. externally replacing the local state.

These operations have different semantics. None may be reported as another without an explicit bridge.

A wider-scope component may expose an advisory interface to a local component. Advice is data delivered through that interface. It does not alter the local construction unless the receiving rule admits and applies it.

### R.8 Recursive composition

Let components \(X_1,\ldots,X_n\) be joined through a typed interface family \(J\):

\[
Y=\mathsf{Compose}_J(X_1,\ldots,X_n).
\]

The composite \(Y\) has its own boundary, identity, access contract and possible capabilities. It MAY expose operations not available from any isolated component. Such an emergent capability must be demonstrated by the declared composition and operation; it is not inferred from the number of components.

Component preservation is separately declared. A composite MUST state whether it retains:

- exact component identities;
- component-local attributes;
- internal access boundaries;
- individual transition authority;
- provenance and withdrawal history;
- shared or independent choice sources.

Packing \(Y\) permits it to participate as one component in a further composition. This is recursive composition, not automatic fusion of all contained identities.

When WPC is selected, composition MUST distinguish the reconstructive whole \(W\) from the compositional whole \(Y\). The synthesis and reconstruction bridges \(\alpha_J,\beta_J\) establish their declared relationship. WC3 requires them to be two-sided inverses on the pinned coherent domains. They do not erase \(Y\)'s component occurrences, and independent decoding of one SR4 portion does not reconstruct the organisation of \(Y\) unless that organisation is also inside the portion's declared payload scope.

### R.9 Relationship to EEC-Q, SF and CFS

RGP specifies structural relations and obligations. It does not prescribe one carrier for every implementation.

- EEC-Q MAY represent finite formal alternatives among exact layer configurations.
- An EEC joint state MAY retain dependence among generated components or connection patterns.
- SF MAY describe a finite or infinite family of generated layers under shared parameters.
- CFS MAY describe a symbolic family whose value is a complete formal layer state.
- `Pack` and `Inside` MAY implement hosted immutable constructions and explicit interior transformation.
- `Pack` followed by exact `Unpack` MAY satisfy the SR4 left-inverse law for its complete quoted payload. This is a full-payload encoding, not by itself a distributed-portion construction.
- EEC-Q, SF or CFS values MAY be encoded only when their complete canonical identity, profile editions and dependency semantics are inside the encoder's declared payload scope.
- WPC contextual expressions MAY be represented as source-retaining views when read-only, or as typed EEC/SF/CFS transformations when state-changing or generative; the selected representation MUST preserve the expression context and provenance.
- WPC composition MAY use EEC joints, SF shared parameters or CFS pointwise dependence, but the bridges \(\alpha_J,\beta_J\), component-participation criterion and transformation witnesses remain separate RGP obligations.

RGP inheritance values are not EEC coefficients. RGP access scopes are not SF parameter domains. RGP regimes are not operational phases until a criterion is supplied. RGP source-retention tiers are not evidence strength or probability. Exact decoding does not execute a decoded quote, rule or state.

### R.10 Structural laws and stop conditions

The following obligations govern RGP/0.2:

| ID | Law or condition |
|---|---|
| R1 | Hosting, generation, encoding, decoding, projection, inheritance and composition are separately typed |
| R2 | Every generative edge records parent, rule, parameters, inherited contract and child edition |
| R3 | Every projection records preservation, loss and reconstruction conditions |
| R4 | A local view does not replace or determine its source without an explicit map and singleton reconstruction result |
| R5 | Shared-source dependence is retained until an explicit identification, restriction or independent-product declaration changes it |
| R6 | Source retention is claimed only at the strongest demonstrated SR tier |
| R7 | Rank, regime, temporal scope, access scope and composition scope are independent coordinates |
| R8 | A whole-history representation does not imply cross-locality control, knowledge or reversed causation |
| R9 | A composite does not erase component identity unless the composition contract explicitly identifies it |
| R10 | Recursive application constructs only finite-rank objects unless a separately defined recursion or limit profile is selected |
| R11 | SR4 requires \(d_i\circ e_i=\operatorname{id}\) on the declared exact source domain; therefore every admitted SR4 encoder is injective there |
| R12 | A lossy local view of an SR4 portion does not remove the portion's encoded payload unless a state-changing operation modifies or replaces it |
| R13 | A digest, pointer or external retrieval path without sufficient local payload cannot establish self-contained SR4 |
| R14 | A whole-bearing portion, its contextual expression, the reconstructive whole and the compositional whole remain separately typed |
| R15 | WC1 requires every admitted portion to decode to one pinned exact source edition; independently valid but different decoded editions fail cross-portion coherence |
| R16 | Every contextual expression records its portion occurrence, full admitted context, derivation mode, preserved invariants and loss account |
| R17 | Declared expression overlaps satisfy their pinned compatibility criteria; absence of a bridge is `unsupported`, not agreement |
| R18 | WC3 requires a component-complete composition, two-sided synthesis/reconstruction bridges \(\alpha_J,\beta_J\), and a participation witness for every admitted occurrence |
| R19 | All-portions SR4 is incompatible with minimal joint necessity for reconstructing the same \(W\) and payload scope; collective necessity may instead concern \(Y\)'s identity or capabilities |
| R20 | WC4 requires individual encoding/decoding transformation squares and the collective composition bridge to commute on their declared common domains |
| R21 | Mixed-edition or partially updated collections do not inherit a prior coherence witness without explicit migration and revalidation |

Execution or derivation MUST stop with `unsupported`, `undetermined`, `domain_error` or a UC5 stop record when a required generator, interface, invariant witness, projection loss account, expression context, overlap bridge, encoder, decoder, synthesis/reconstruction bridge, transformation witness, transition rule or access policy is unavailable.

### R.11 Worked structural example

Consider a platform layer \(P\) with a fixed message schema, a permitted rule grammar and an audit invariant \(k\). A registered generator creates two workspace layers from a shared release parameter \(t\):

\[
W_A(t)=\mathsf{Generates}_{g_A}(P,t),
\qquad
W_B(t)=\mathsf{Generates}_{g_B}(P,t).
\]

Both workspaces retain the same release assignment and satisfy:

\[
k(W_A(t))=k(W_B(t))=k(P).
\]

They therefore establish SR1 for \(k\). If each also carries a restricted workspace generator, it may establish SR2 for that declared output class. Neither establishes SR3 unless a decoder reconstructs \(P\) under a pinned equivalence.

Now let a registered reversible encoder place the complete canonical platform definition into a portion carried by each workspace:
...
with bound decoders satisfying:
...
On the declared finite platform carrier, exhaustive canonical round-trip comparison establishes SR4 for both portions. Replacing the payload by only `digest(P)` would reduce the result to SR0 because the digest cannot reproduce \(P\) without external source content.

An operator role sees:

\[
V_A=\mathsf{View}_{\pi_A}(W_A(t)),
\]

which displays current tasks but hides the generator, release parameter and audit implementation. Equality of two such displays does not establish equality of the workspaces. The source-retaining model records the hidden fields even though the operator role cannot access them.

The operator view may also hide \(F_A\). This does not invalidate \(d_A(F_A)=P\), because the view and the encoded portion are different objects. If a mutation truncates \(F_A\), the resulting portion must be decoded and checked again; its prior SR4 witness cannot be reused.

The two workspaces are composed through a message interface:

\[
C=\mathsf{Compose}_J(W_A(t),W_B(t)).
\]

Because the release choice is shared, replacing \(t\) by independent parameters \(t_A,t_B\) creates a different construction. Packing \(C\) permits it to be hosted by another platform layer without executing or merging its interior components.

For WPC, take the reconstructive whole to be the canonical platform definition \(P\), including the declared workspace-occurrence and interface schema, and the indexed portions to be \((A,F_A)\) and \((B,F_B)\). Define:

\[
\alpha_{J_P}(P)
=\mathsf{Compose}_{J_P}((A,F_A),(B,F_B))
=Y.
\]

The occurrence indices remain part of \(Y\)'s identity even if the encoded payloads are byte-identical. The common-source witness is:

\[
d_A(F_A)=d_B(F_B)=P.
\]

Let an operator context expose task execution through \(A\), while an auditor context exposes invariant evidence through \(B\):

\[
X_{A,\xi_{op}}=\chi_A(F_A,\xi_{op}),
\qquad
X_{B,\xi_{audit}}=\chi_B(F_B,\xi_{audit}).
\]

These expressions may be different while remaining expressions of portions bearing the same \(P\). If both expose the release identifier, their overlap maps must agree on that identifier. No agreement is inferred for fields outside the declared overlap.

Define \(\beta_{J_P}\) to verify both payload editions, their equality after exact decoding, the presence of occurrences \(A\) and \(B\), and the required message interface before returning \(P\). Then the two-sided bridge laws are:

\[
\beta_{J_P}(\alpha_{J_P}(P))=P,
\qquad
\alpha_{J_P}(\beta_{J_P}(Y))=Y.
\]

Removing either occurrence produces a different compositional whole under a criterion that observes workspace participation, even though the remaining SR4 portion can still reconstruct \(P\). Thus every piece participates in the organisation of \(Y\), while every piece independently bears the reconstructive whole.

For a platform migration \(T(P)=P'\), registered workspace updates \(U_A,U_B\) establish WC4 only when:
...
and the individual decoder laws and collective bridge all return \(P'\). While only one workspace has migrated, each payload may be individually valid for its own edition, but the pair is not source-coherent and is reported as `coherence_pending` or `coherence_conflict` according to the migration protocol.

This example exercises recursive generation, shared dependence, invariant inheritance, exact whole-bearing encoding, contextual expression, overlap agreement, collective reconstruction, transformation coherence, access-limited projection, composition and lifting without assigning external ontological meaning to the hierarchy.

### R.12 Conformance and development boundary

A minimal RGP conformance suite MUST include:

- a hosted object not generated by its host;
- a generated object not hosted by its generator;
- SR0 without SR1;
- SR1 without SR2 or SR3;
- SR3 under a non-identity criterion that is rejected as SR4;
- an SR4 exact encode–decode round trip;
- injectivity over the recorded bounded SR4 source domain;
- an all-portions SR4 claim checked for every admitted portion index;
- a digest or external source reference rejected as self-contained SR4;
- a lossy local view that leaves the encoded portion and its SR4 witness unchanged;
- a damaged portion whose previous SR4 witness is rejected;
- two individually valid SR4 portions decoding to different source editions and therefore failing WC2;
- two differentiated contextual expressions that agree on a declared overlap without being globally identical;
- an expression-overlap check rejected when its bridge or criterion is missing;
- a WC3 composite that retains every indexed occurrence and satisfies both \(\beta_J\circ\alpha_J=\operatorname{id}\) and \(\alpha_J\circ\beta_J=\operatorname{id}\) on the recorded coherent domains;
- a left-invertible collective reconstruction rejected as WC3 when collective closure fails;
- a removed occurrence that changes the compositional whole while leaving the reconstructive whole recoverable from a remaining SR4 portion;
- a rejected claim that all SR4 portions are jointly necessary to reconstruct the same exact source scope;
- commuting individual encode–transform and decode–transform cases;
- a commuting collective transformation case;
- a mixed-edition update reported as pending or conflicting rather than coherent;
- a non-injective local projection with at least two compatible sources;
- shared descendants that differ from an independent product;
- equal rank with different regimes;
- equal regime with different ranks;
- a whole-history view that does not authorise a local transition;
- a composite that preserves component identities;
- a rejected attempt to infer external instantiation from structural validity.

RGP/0.2 and WPC/0.1 currently supply a structural specification and worked derivation, not a separate executable reference model. Existing FG3, IC and CG3 validation counts are unchanged. A bounded implementation SHOULD first reuse the existing quote, joint-dependence, view and family-state machinery, then add explicit layer records, generative edges, encoder–decoder bindings, contextual-expression records, overlap contracts, source-retention witnesses, whole bridges, transformation-coherence witnesses and independent placement coordinates.

Promotion beyond the experimental profile requires a canonical interchange schema, an executable bounded model, positive and negative conformance cases, at least one useful end-to-end program and an independent review of the relation typing, source-retention hierarchy, SR4 information-capacity assumptions, whole–portion distinction and coherence laws.

## X.19 Optional reciprocal whole–part constitution — WPC/0.2
...
## X.20 Optional Reasoning–Evidence Calculus — REC/0.1

Added in predecessor revision **REC1**, 2026-09-15. The following standalone profile is reproduced here unchanged as part of the v0.15 source. The versioned package supplies the bounded REC-B1/0.1 evaluator, schema, fixtures, tests, validation record and conformance matrix.
...
## X.21 Optional Multi-Scope Coherence — MSC/0.1

This section incorporates the complete merged `MSC/0.1` proposal as an integral, separately selectable member of the v0.15 source family. Its **formal definition is canonical within the selected experimental profile**, while its stated research and implementation limitations remain in force. The historical companion file and its `MSC-B1/0.1` model remain pinned; the incorporation changes neither their identifiers nor their bounded conformance. MSC does not impose a physical hierarchy, an authority relation, or an infinite ontology.

<!-- BEGIN INHERITED MSC/0.1 BODY -->
...
**Later work outside this edition.** E7C/0.1 is a separate, unfinished calculus build; REC-EVAL is an empirical protocol, and the relational non-separability clarification remains an independently reviewed proposal. Their presence in the successor inventory does not turn them into new mathematical axioms, release an implementation, or change the source labels of older editions. See `docs/CANONICAL_SUCCESSOR_DECISION.md` for lineage and migration.
...
The following reference body is reproduced unchanged from the repository's **E7G-T_Kernel_v0.11_UC5_Unified_Public_Reference_Specification.md** predecessor. Its internal section numbering, older version strings, public-reference anchors and informative module labels are historical source content. Read its concepts together with the v0.15 scope in §X.0 and the explicit migration refinements in §X.14. This inclusion makes the document self-contained; it does not claim that the predecessor's maturity gates have been passed.

Source metadata, retained for provenance rather than as v0.15 front matter:
...
# v0.14 draft provenance and closing anchor

| Source | Role | SHA-256 of release bytes |
|---|---|---|
| E7G-T Kernel v0.13-experimental-RWP1-draft | Immediate self-contained predecessor and WPC/0.2 source | `ecade9da08df04d257735d399848ebf2231590cabab8e48fa0b228db3051bdbe` |
| E7G-T REC/0.1 Reasoning–Evidence Calculus Profile | Standalone normative companion reproduced in §X.20 | `52b88f24e8fbbd2aef7dc221978be844790ae1c476ea7133ceedef9fde0ebbc3` |
| REC-B1/0.1 reference evaluator | Bounded finite claim–evidence information-flow model | `8902086db749567b0360bbb7ec4e71127f272791bf27b14d5f89b7049c197c55` |
| REC-B1/0.1 independent trace checker | Separately implemented deterministic replay checker | `ff145ff10f60ab440602f2de87d94dc51d865ef29478ad486d191ee291cac304` |
| REC/0.1 reasoning-envelope schema | Bounded JSON interchange schema | `7857ec7573f31b1304ae81ca905a100aab06af84d1a41d9caf5278c346edfd50` |
| REC/0.1 conformance matrix | Obligation-to-implementation capability map | `0019101f8105ecb466b59d536b526d702a4670c2afd4f51c3f4bee6c295e45c5` |
| REC/0.1 validation record | Commands, results, hashes, scope and omissions | `e10dea27260d89c1bc38408bf8b902ad125f5a742e9569af22e6c68193246aac` |
| E7G-T Kernel v0.12.2-experimental-WPC1 | v0.13 predecessor and legacy WPC/0.1 base | `c36225ef601b82eb025872f53e7a881bbc257d4668df3ae4733113c32bf21515` |
| E7G-T Reciprocal Whole–Part Kernel WPC/0.2 proposal | Reviewed design source for reciprocal constitution and evolution | `6216f109ca0d81d7b94bbf111434aa508254e138e095e79dc78fff8fbd1e1264` |
| E7G-T WPC/0.2 Reciprocal Whole–Part Profile | Standalone normative companion extracted from §X.19 | `e1ebd7d3b1945f816fa21aee5d1c4802486d0b7cc2e097a99c96ec1c60d1cd3c` |
| E7G-T WPC/0.2 Reference Model | Versioned bounded allocation implementation | `5fe2e8d5f913f92ad8fbd0575607f569cbd211b13970174d537a9af14a493ea3` |
| E7G-T WPC/0.2 External Test Wrapper | Standard-library first-party regression tests | `9af439dfeb6502a80a72112838a6a3476b0b008625f6c6975872c7258b5e4e43` |
| E7G-T WPC/0.2 Validation Record | Recorded commands, checks, scope and omissions | `230fc58a03f06a025f6ddf2017e40851205e4e953a4d27b262b31b81bd8e1b0f` |
| E7G-T WPC/0.2 Conformance Matrix | Obligation-to-implementation capability map | `ca4384f5534ce4966ca5d5b5d45c99dfae1e3056ee3dd50c962696ba695bccea` |
| E7G-T Kernel v0.12.1-experimental | RGP2 and SR4 source retained through v0.12.2 | `4c7784bcd653471a097329361b17b13c3b45e1592df6204243370ca0190935b1` |
...
Version 0.14 is drafted as the successor to the v0.13 RWP1 candidate. It retains EEC-Q, SF, CFS, RGP/0.2, WPC/0.1 and the proposed WPC/0.2 family without changing their meanings. Revision REC1 proposes REC/0.1 with typed claims, evidence, rules and queries; independent support/refutation bits; four non-collapsing information statuses; finite deterministic rule closure; scope, temporal and modality safety; reliance and abstention policies; and a replayable reasoning witness. REC-B1/0.1 passes 34 internal checks and 24 external first-party unit tests, and its fixture passes the separately implemented trace checker. These results validate bounded information flow only. They do not validate source truth, domain rules, complete logical inference, improved AI performance or independent reproduction. The inherited UC5 body remains unchanged. No predecessor or product pin is modified by this draft.

**Working anchor:** construct entities with declared boundaries; constitute the semantic whole before evaluating its representations; distinguish claim content, evidence role, information status, source truth and action authority; retain support and refutation independently; admit only declared rule applications; reject hidden scope, temporal and modality expansion; bind each result to its exact sources and edition; replay its witness independently; and abstain when the evidence and policy do not warrant reliance.

End of **E7G-T Kernel v0.14-experimental-REC1-draft — Executable Extension, Reciprocal Constitution and Checkable Reasoning**.
