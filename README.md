...
The [post-v0.12.1 gap and proposal register](roadmaps/E7C_0.1_POST_V0121_GAP_AND_PROPOSAL_REGISTER.md) must be completed and reviewed before the first executable foundation slice. This prevents E7C from freezing known v0.12.1 gaps or treating later suggestions as canonical without evidence.
