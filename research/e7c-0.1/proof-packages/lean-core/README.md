...
only the declaration identity needed by the fragment. The external static row is represented by an extensional predicate generated by
finite constructor unions. The separate `staticTrace` list preserves
